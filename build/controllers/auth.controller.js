...
var signIn = exports.signIn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var usuarioEncontrado, matchPass, token, cookieconfig, postmanValid;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", res.redirect('/?error=credenciales_invalidas'));
        case 6:
          _context.next = 8;
        ...
        case 8:
          ...
          return _context.abrupt("return", res.redirect('/?error'));
        case 11:
          ...
          postmanValid = req.headers['content-type'];
        ...
        case 17:
          return _context.abrupt("return", res.redirect('/postlog'));
        case 20:
          _context.prev = 20;
...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, nombre, apellido, contrasena, correo, telefono, role, nuevoUsuario, foundRoles, defaultRole, _defaultRole, emailFound, usuarioGuardado, postmanValid;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          _context2.t4 = correo;
          _context2.t5 = telefono;
          _context2.t6 = role;
          _context2.t7 = {
            nombre: _context2.t1,
            apellido: _context2.t2,
            contrasena: _context2.t3,
            correo: _context2.t4,
            telefono: _context2.t5,
            role: _context2.t6
          };
          nuevoUsuario = new _context2.t0(_context2.t7);
          if (!role) {
            _context2.next = 24;
            break;
          }
        ...
        case 30:
          ...
          return _context2.abrupt("return", res.redirect('/register?error=email_existente'));
        case 33:
          _context2.next = 35;
        ...
        case 39:
          return _context2.abrupt("return", res.redirect('/') //Redirige al inicio de sesión 
          );
        case 40:
        case "end":
